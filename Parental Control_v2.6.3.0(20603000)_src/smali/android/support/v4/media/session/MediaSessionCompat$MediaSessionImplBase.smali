...
.field private mRemoteUserInfo:Landroidx/media/h$b;
...
.field private mVolumeCallback:Landroidx/media/q$d;

.field mVolumeProvider:Landroidx/media/q;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroidx/versionedparcelable/g;Landroid/os/Bundle;)V
    ...
    .line 31
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/q$d;
    ...
    .line 67
    invoke-direct {p1, p3, p2, p5}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Landroidx/versionedparcelable/g;)V
...
.method adjustVolume(II)V
    ...
    .line 6
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/q;

    .line 8
    if-eqz p2, :cond_1

    .line 10
    invoke-virtual {p2, p1}, Landroidx/media/q;->f(I)V
...
.method public getCurrentControllerInfo()Landroidx/media/h$b;
    ...
    .line 4
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Landroidx/media/h$b;
...
.method public setCurrentControllerInfo(Landroidx/media/h$b;)V
    ...
    .line 4
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Landroidx/media/h$b;
...
.method public setPlaybackToLocal(I)V
    ...
    .prologue
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/q;
    ...
    .line 6
    invoke-virtual {v0, v1}, Landroidx/media/q;->h(Landroidx/media/q$d;)V
...
.method public setPlaybackToRemote(Landroidx/media/q;)V
    ...
    .line 14
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/q;
    ...
    .line 22
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/q;

    .line 24
    invoke-virtual {v1}, Landroidx/media/q;->c()I
    ...
    .line 30
    invoke-virtual {v1}, Landroidx/media/q;->b()I
    ...
    .line 36
    invoke-virtual {v1}, Landroidx/media/q;->a()I
    ...
    .line 47
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/q$d;

    .line 49
    invoke-virtual {p1, v0}, Landroidx/media/q;->h(Landroidx/media/q$d;)V
