.class public Landroidx/appcompat/graphics/drawable/f;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/graphics/drawable/f$a;
    }
.end annotation
...
# instance fields
.field private M:Landroidx/appcompat/graphics/drawable/f$a;
...
.method static constructor <clinit>()V
    ...
    const-string v0, "StateListDrawableCompat"

    sput-object v0, Landroidx/appcompat/graphics/drawable/f;->V:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0, v0, v0}, Landroidx/appcompat/graphics/drawable/f;-><init>(Landroidx/appcompat/graphics/drawable/f$a;Landroid/content/res/Resources;)V

    return-void
.end method

.method constructor <init>(Landroidx/appcompat/graphics/drawable/f$a;)V
    .locals 0
    .param p1    # Landroidx/appcompat/graphics/drawable/f$a;
    ...
    .line 7
    invoke-virtual {p0, p1}, Landroidx/appcompat/graphics/drawable/f;->i(Landroidx/appcompat/graphics/drawable/b$d;)V

    :cond_0
    return-void
.end method

.method constructor <init>(Landroidx/appcompat/graphics/drawable/f$a;Landroid/content/res/Resources;)V
    .locals 1
    ...
    .line 3
    new-instance v0, Landroidx/appcompat/graphics/drawable/f$a;

    invoke-direct {v0, p1, p0, p2}, Landroidx/appcompat/graphics/drawable/f$a;-><init>(Landroidx/appcompat/graphics/drawable/f$a;Landroidx/appcompat/graphics/drawable/f;Landroid/content/res/Resources;)V

    .line 4
    invoke-virtual {p0, v0}, Landroidx/appcompat/graphics/drawable/f;->i(Landroidx/appcompat/graphics/drawable/b$d;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/graphics/drawable/f;->onStateChange([I)Z
...
.method private w(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .prologue
    .line 1
    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/f;->M:Landroidx/appcompat/graphics/drawable/f$a;
    ...
    .line 62
    invoke-virtual {v6, p1, v4}, Landroidx/appcompat/widget/j1;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_3
    invoke-virtual {v0, v3, v4}, Landroidx/appcompat/graphics/drawable/f$a;->D([ILandroid/graphics/drawable/Drawable;)I
...
.method b()V
    ...
    .line 5
    iput-boolean v0, p0, Landroidx/appcompat/graphics/drawable/f;->Q:Z
...
.method bridge synthetic c()Landroidx/appcompat/graphics/drawable/b$d;
    ...
    .prologue
    .line 1
    invoke-virtual {p0}, Landroidx/appcompat/graphics/drawable/f;->o()Landroidx/appcompat/graphics/drawable/f$a;
...
.method i(Landroidx/appcompat/graphics/drawable/b$d;)V
    ...
    .line 4
    instance-of v0, p1, Landroidx/appcompat/graphics/drawable/f$a;

    .line 6
    if-eqz v0, :cond_0

    .line 8
    check-cast p1, Landroidx/appcompat/graphics/drawable/f$a;

    .line 10
    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/f;->M:Landroidx/appcompat/graphics/drawable/f$a;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 1
    iget-boolean v0, p0, Landroidx/appcompat/graphics/drawable/f;->Q:Z
    ...
    .line 13
    invoke-virtual {v0}, Landroidx/appcompat/graphics/drawable/f$a;->v()V
...
.method public n([ILandroid/graphics/drawable/Drawable;)V
    ...
    .line 5
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/graphics/drawable/f$a;->D([ILandroid/graphics/drawable/Drawable;)I
...
.method o()Landroidx/appcompat/graphics/drawable/f$a;
    .locals 3
    ...
    .line 3
    iget-object v1, p0, Landroidx/appcompat/graphics/drawable/f;->M:Landroidx/appcompat/graphics/drawable/f$a;

    .line 5
    const/4 v2, 0x0

    .line 6
    invoke-direct {v0, v1, p0, v2}, Landroidx/appcompat/graphics/drawable/f$a;-><init>(Landroidx/appcompat/graphics/drawable/f$a;Landroidx/appcompat/graphics/drawable/f;Landroid/content/res/Resources;)V
...
.method protected onStateChange([I)Z
    ...
    .line 7
    invoke-virtual {v1, p1}, Landroidx/appcompat/graphics/drawable/f$a;->E([I)I
    ...
    .line 13
    iget-object p1, p0, Landroidx/appcompat/graphics/drawable/f;->M:Landroidx/appcompat/graphics/drawable/f$a;

    .line 15
    sget-object v1, Landroid/util/StateSet;->WILD_CARD:[I

    .line 17
    invoke-virtual {p1, v1}, Landroidx/appcompat/graphics/drawable/f$a;->E([I)I
...
.method q()I
    ...
    .line 3
    iget v0, v0, Landroidx/appcompat/graphics/drawable/b$d;->h:I
...
.method s([I)I
    ...
    .line 3
    invoke-virtual {v0, p1}, Landroidx/appcompat/graphics/drawable/f$a;->E([I)I
...
.method t()Landroidx/appcompat/graphics/drawable/f$a;
    .locals 1
...
.method u(I)[I
    ...
    .line 3
    iget-object v0, v0, Landroidx/appcompat/graphics/drawable/f$a;->J:[[I
...
.method public v(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 17
    invoke-direct {p0, v0}, Landroidx/appcompat/graphics/drawable/f;->x(Landroid/content/res/TypedArray;)V
    ...
    .line 26
    invoke-direct/range {p0 .. p5}, Landroidx/appcompat/graphics/drawable/f;->w(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
