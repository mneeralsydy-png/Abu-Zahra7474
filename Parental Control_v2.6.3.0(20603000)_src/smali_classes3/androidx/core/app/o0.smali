...
.method public static g(Landroid/content/Context;ILandroid/content/Intent;IZ)Landroid/app/PendingIntent;
    ...
    .line 5
    invoke-static {p0, p1, p2, p3}, Landroidx/core/app/o0$b;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method public static i(Landroid/app/PendingIntent;ILandroid/app/PendingIntent$OnFinished;Landroid/os/Handler;)V
    ...
    .prologue
    .line 1
    new-instance v0, Landroidx/core/app/o0$d;

    .line 3
    invoke-direct {v0, p2}, Landroidx/core/app/o0$d;-><init>(Landroid/app/PendingIntent$OnFinished;)V

    .line 6
    :try_start_0
    invoke-virtual {v0}, Landroidx/core/app/o0$d;->c()Landroid/app/PendingIntent$OnFinished;
    ...
    .line 13
    invoke-virtual {v0}, Landroidx/core/app/o0$d;->b()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 16
    invoke-virtual {v0}, Landroidx/core/app/o0$d;->close()V
...
.method public static k(Landroid/app/PendingIntent;Landroid/content/Context;ILandroid/content/Intent;Landroid/app/PendingIntent$OnFinished;Landroid/os/Handler;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 3
    invoke-direct {v0, p4}, Landroidx/core/app/o0$d;-><init>(Landroid/app/PendingIntent$OnFinished;)V

    .line 6
    :try_start_0
    invoke-static/range {p0 .. p7}, Landroidx/core/app/o0$a;->a(Landroid/app/PendingIntent;Landroid/content/Context;ILandroid/content/Intent;Landroid/app/PendingIntent$OnFinished;Landroid/os/Handler;Ljava/lang/String;Landroid/os/Bundle;)V
