...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "",
        "b",
        "(Landroidx/credentials/provider/z0;)Z",
        "Landroid/app/slice/Slice;",
        "c",
        "(Landroidx/credentials/provider/z0;)Landroid/app/slice/Slice;",
        "slice",
        "a",
        "(Landroid/app/slice/Slice;)Landroidx/credentials/provider/z0;",
        "credentials_release"
    }
    k = 0x1
    mv = {
...
.method public static final a(Landroid/app/slice/Slice;)Landroidx/credentials/provider/z0;
    .locals 20
    ...
    .line 271
    invoke-virtual {v0, v1, v2}, Landroidx/credentials/provider/y$a;->b(Landroid/os/Bundle;Ljava/lang/String;)Landroidx/credentials/provider/y;
...
.method public static final b(Landroidx/credentials/provider/z0;)Z
    .locals 2
    ...
    .line 6
    invoke-static {p0}, Landroidx/credentials/provider/z0;->i(Landroidx/credentials/provider/z0;)Z
    ...
    .line 12
    invoke-static {p0}, Landroidx/credentials/provider/z0;->j(Landroidx/credentials/provider/z0;)Z
    ...
    .line 17
    :cond_0
    invoke-virtual {p0}, Landroidx/credentials/provider/z0;->n()Landroid/graphics/drawable/Icon;
    ...
    .line 36
    sget v0, Landroidx/credentials/t1$a;->c:I
...
.method public static final c(Landroidx/credentials/provider/z0;)Landroid/app/slice/Slice;
    .locals 16
    .param p0    # Landroidx/credentials/provider/z0;
        .annotation build Ljj/l;
        .end annotation
    ...
    .line 12
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->r()Ljava/lang/CharSequence;

    .line 15
    move-result-object v2

    .line 16
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->m()Ljava/lang/CharSequence;

    .line 19
    move-result-object v3

    .line 20
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->p()Landroid/app/PendingIntent;

    .line 23
    move-result-object v4

    .line 24
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->q()Ljava/lang/CharSequence;

    .line 27
    move-result-object v5

    .line 28
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->o()Ljava/time/Instant;

    .line 31
    move-result-object v6

    .line 32
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->n()Landroid/graphics/drawable/Icon;

    .line 35
    move-result-object v7

    .line 36
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->t()Z
    ...
    .line 176
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->s()Z
    ...
    :catch_0
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/z0;->u()Z
