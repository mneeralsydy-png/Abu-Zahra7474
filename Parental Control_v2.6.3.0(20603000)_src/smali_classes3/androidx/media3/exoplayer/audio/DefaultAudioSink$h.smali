...
# direct methods
.method public constructor <init>(Landroidx/media3/common/w;IIIIIIILandroidx/media3/common/audio/b;ZZZ)V
    .locals 0
    ...
    .line 4
    iput-object p1, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->a:Landroidx/media3/common/w;
    ...
    .line 20
    iput-object p9, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->i:Landroidx/media3/common/audio/b;
...
.method private e(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    .locals 2
    ...
    .line 7
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->g(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    ...
    .line 16
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->f(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    ...
    .line 21
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->h(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
...
.method private f(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    .locals 7
    ...
    .line 3
    iget-boolean v0, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->l:Z

    .line 5
    invoke-static {p1, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->j(Landroidx/media3/common/d;Z)Landroid/media/AudioAttributes;

    .line 8
    move-result-object v1

    .line 9
    iget p1, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->e:I

    .line 11
    iget v0, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->f:I

    .line 13
    iget v2, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->g:I

    .line 15
    invoke-static {p1, v0, v2}, Landroidx/media3/common/util/i1;->Z(III)Landroid/media/AudioFormat;
...
.method private g(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    .locals 3
    .annotation build Landroidx/annotation/x0;
        value = 0x1d
    .end annotation
    ...
    .line 7
    invoke-static {v0, v1, v2}, Landroidx/media3/common/util/i1;->Z(III)Landroid/media/AudioFormat;

    .line 10
    move-result-object v0

    .line 11
    iget-boolean v1, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->l:Z

    .line 13
    invoke-static {p1, v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->j(Landroidx/media3/common/d;Z)Landroid/media/AudioAttributes;
    ...
    .line 45
    iget p2, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->c:I
    ...
    .line 51
    :goto_0
    invoke-static {p1, v0}, Landroidx/media3/exoplayer/audio/q0;->a(Landroid/media/AudioTrack$Builder;Z)Landroid/media/AudioTrack$Builder;
...
.method private h(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    .locals 8
    ...
    .line 3
    invoke-static {p1}, Landroidx/media3/common/util/i1;->G0(I)I
    ...
    .line 15
    iget v4, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->g:I

    .line 17
    iget v5, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->h:I
...
.method private static j(Landroidx/media3/common/d;Z)Landroid/media/AudioAttributes;
    .locals 0
    .annotation build Landroidx/annotation/x0;
        value = 0x15
    .end annotation
    ...
    .line 3
    invoke-static {}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->k()Landroid/media/AudioAttributes;
    ...
    .line 8
    :cond_0
    invoke-virtual {p0}, Landroidx/media3/common/d;->b()Landroidx/media3/common/d$d;
...
.method public a(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    ...
    .line 1
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->e(Landroidx/media3/common/d;I)Landroid/media/AudioTrack;
    ...
    .line 22
    iget v4, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->h:I

    .line 24
    iget-object v5, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->a:Landroidx/media3/common/w;

    .line 26
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->m()Z
    ...
    .line 32
    invoke-direct/range {v0 .. v7}, Landroidx/media3/exoplayer/audio/AudioSink$InitializationException;-><init>(IIIILandroidx/media3/common/w;ZLjava/lang/Exception;)V
...
.method public c(Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;)Z
    .locals 2
...
.method public d(I)Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;
    .locals 14
    ...
    .line 3
    iget-object v1, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->a:Landroidx/media3/common/w;
    ...
    .line 17
    iget-object v9, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->i:Landroidx/media3/common/audio/b;
    ...
    .line 27
    invoke-direct/range {v0 .. v12}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;-><init>(Landroidx/media3/common/w;IIIIIIILandroidx/media3/common/audio/b;ZZZ)V
...
.method public i(J)J
    ...
    .line 3
    invoke-static {p1, p2, v0}, Landroidx/media3/common/util/i1;->Y1(JI)J
...
.method public l(J)J
    ...
    .prologue
    .line 1
    iget-object v0, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$h;->a:Landroidx/media3/common/w;
