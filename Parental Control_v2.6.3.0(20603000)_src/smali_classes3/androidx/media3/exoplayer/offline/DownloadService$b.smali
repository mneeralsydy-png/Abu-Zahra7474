...
# interfaces
.implements Landroidx/media3/exoplayer/offline/p$d;
...
.field private final b:Landroidx/media3/exoplayer/offline/p;

.field private final c:Z

.field private final d:Landroidx/media3/exoplayer/scheduler/e;
...
# direct methods
.method private constructor <init>(Landroid/content/Context;Landroidx/media3/exoplayer/offline/p;ZLandroidx/media3/exoplayer/scheduler/e;Ljava/lang/Class;)V
    .locals 0
    .param p4    # Landroidx/media3/exoplayer/scheduler/e;
        .annotation build Landroidx/annotation/q0;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Z",
            "Landroidx/media3/exoplayer/scheduler/e;",
            "Ljava/lang/Class<",
            "+",
            "Landroidx/media3/exoplayer/offline/DownloadService;",
            ">;)V"
    ...
    .line 4
    iput-object p2, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->b:Landroidx/media3/exoplayer/offline/p;

    .line 5
    iput-boolean p3, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->c:Z

    .line 6
    iput-object p4, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->d:Landroidx/media3/exoplayer/scheduler/e;

    .line 7
    iput-object p5, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->e:Ljava/lang/Class;

    .line 8
    invoke-virtual {p2, p0}, Landroidx/media3/exoplayer/offline/p;->e(Landroidx/media3/exoplayer/offline/p$d;)V
...
.method synthetic constructor <init>(Landroid/content/Context;Landroidx/media3/exoplayer/offline/p;ZLandroidx/media3/exoplayer/scheduler/e;Ljava/lang/Class;Landroidx/media3/exoplayer/offline/DownloadService$a;)V
    .locals 0

    .prologue
    .line 1
    invoke-direct/range {p0 .. p5}, Landroidx/media3/exoplayer/offline/DownloadService$b;-><init>(Landroid/content/Context;Landroidx/media3/exoplayer/offline/p;ZLandroidx/media3/exoplayer/scheduler/e;Ljava/lang/Class;)V
...
.method static synthetic i(Landroidx/media3/exoplayer/offline/DownloadService$b;)Landroidx/media3/exoplayer/offline/p;
    .locals 0

    .prologue
    .line 1
    iget-object p0, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->b:Landroidx/media3/exoplayer/offline/p;
...
.method private k()V
    ...
    .line 13
    iget-object v1, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->d:Landroidx/media3/exoplayer/scheduler/e;

    .line 15
    invoke-interface {v1}, Landroidx/media3/exoplayer/scheduler/e;->cancel()Z
...
.method private synthetic m(Landroidx/media3/exoplayer/offline/DownloadService;)V
    ...
    .prologue
    .line 1
    iget-object v0, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->b:Landroidx/media3/exoplayer/offline/p;
...
.method private n()V
    ...
    .line 19
    invoke-static {v2, v0}, Landroidx/media3/common/util/i1;->p2(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    :try_end_0
...
# virtual methods
.method public a(Landroidx/media3/exoplayer/offline/p;Z)V
    .locals 1
    ...
    .line 3
    invoke-virtual {p1}, Landroidx/media3/exoplayer/offline/p;->i()Z
    ...
    .line 15
    invoke-virtual {p1}, Landroidx/media3/exoplayer/offline/p;->g()Ljava/util/List;
...
.method public b(Landroidx/media3/exoplayer/offline/p;Landroidx/media3/exoplayer/offline/c;)V
    .locals 0
...
.method public d(Landroidx/media3/exoplayer/offline/p;Landroidx/media3/exoplayer/scheduler/Requirements;I)V
    .locals 0
...
.method public e(Landroidx/media3/exoplayer/offline/p;Landroidx/media3/exoplayer/offline/c;Ljava/lang/Exception;)V
    .locals 0
...
.method public final f(Landroidx/media3/exoplayer/offline/p;)V
    .locals 0
...
.method public g(Landroidx/media3/exoplayer/offline/p;)V
    .locals 1
...
.method public j(Landroidx/media3/exoplayer/offline/DownloadService;)V
    ...
    .line 15
    invoke-virtual {v0}, Landroidx/media3/exoplayer/offline/p;->p()Z
    ...
    .line 25
    new-instance v1, Landroidx/media3/exoplayer/offline/t;

    .line 27
    invoke-direct {v1, p0, p1}, Landroidx/media3/exoplayer/offline/t;-><init>(Landroidx/media3/exoplayer/offline/DownloadService$b;Landroidx/media3/exoplayer/offline/DownloadService;)V
...
.method public q()Z
    ...
    .line 3
    invoke-virtual {v0}, Landroidx/media3/exoplayer/offline/p;->q()Z
    ...
    .line 22
    invoke-virtual {v0}, Landroidx/media3/exoplayer/offline/p;->m()Landroidx/media3/exoplayer/scheduler/Requirements;
    ...
    .line 28
    invoke-interface {v1, v0}, Landroidx/media3/exoplayer/scheduler/e;->b(Landroidx/media3/exoplayer/scheduler/Requirements;)Landroidx/media3/exoplayer/scheduler/Requirements;
    ...
    .line 56
    iget-object v4, p0, Landroidx/media3/exoplayer/offline/DownloadService$b;->d:Landroidx/media3/exoplayer/scheduler/e;

    .line 58
    const-string v5, "androidx.media3.exoplayer.downloadService.action.RESTART"

    .line 60
    invoke-interface {v4, v0, v1, v5}, Landroidx/media3/exoplayer/scheduler/e;->a(Landroidx/media3/exoplayer/scheduler/Requirements;Ljava/lang/String;Ljava/lang/String;)Z
