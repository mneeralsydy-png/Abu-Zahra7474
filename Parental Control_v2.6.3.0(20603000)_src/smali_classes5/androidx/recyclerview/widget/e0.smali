...
.method public constructor <init>()V
    ...
    .line 9
    iput-object v0, p0, Landroidx/recyclerview/widget/e0;->c:Landroidx/recyclerview/widget/RecyclerView$s;
...
.method private g()V
    ...
    .line 3
    iget-object v1, p0, Landroidx/recyclerview/widget/e0;->c:Landroidx/recyclerview/widget/RecyclerView$s;
    ...
    .line 11
    invoke-virtual {v0, v1}, Landroidx/recyclerview/widget/RecyclerView;->q2(Landroidx/recyclerview/widget/RecyclerView$q;)V
...
.method private j()V
    ...
    .line 3
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView;->Q0()Landroidx/recyclerview/widget/RecyclerView$q;
    ...
    .line 18
    invoke-virtual {v0, p0}, Landroidx/recyclerview/widget/RecyclerView;->q2(Landroidx/recyclerview/widget/RecyclerView$q;)V
...
.method private k(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;II)Z
    ...
    .line 7
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/e0;->e(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    .line 14
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Landroidx/recyclerview/widget/e0;->i(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;II)I
    ...
    .line 22
    :cond_2
    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView$z;->q(I)V

    .line 25
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->k2(Landroidx/recyclerview/widget/RecyclerView$z;)V
...
.method public a(II)Z
    ...
    .line 13
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView;->t0()Landroidx/recyclerview/widget/RecyclerView$h;
    ...
    .line 38
    :cond_2
    invoke-direct {p0, v0, p1, p2}, Landroidx/recyclerview/widget/e0;->k(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;II)Z
...
.method protected e(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    .prologue
    .line 1
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/e0;->f(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/s;
...
.method protected f(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/s;
    .locals 1
    .param p1    # Landroidx/recyclerview/widget/RecyclerView$LayoutManager;
        .annotation build Landroidx/annotation/o0;
        .end annotation
...
.method l()V
    ...
    .line 13
    :cond_1
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/e0;->h(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    .line 20
    :cond_2
    invoke-virtual {p0, v0, v1}, Landroidx/recyclerview/widget/e0;->c(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
