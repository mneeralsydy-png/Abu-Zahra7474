...
.method public static a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 1
    invoke-static {p0, p0, p1, p2}, Lcom/bumptech/glide/load/resource/drawable/i;->c(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p0, p1, p2, v0}, Lcom/bumptech/glide/load/resource/drawable/i;->c(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private static c(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    :try_start_0
    sget-boolean v0, Lcom/bumptech/glide/load/resource/drawable/i;->a:Z

    .line 3
    if-eqz v0, :cond_1

    .line 5
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/drawable/i;->e(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 32
    sput-boolean p0, Lcom/bumptech/glide/load/resource/drawable/i;->a:Z
    ...
    .line 41
    :goto_0
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/drawable/i;->d(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
