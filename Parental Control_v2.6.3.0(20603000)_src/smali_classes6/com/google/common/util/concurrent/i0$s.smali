...
# direct methods
.method private constructor <init>(Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;)V
    .locals 3
    ...
    .prologue
    .line 2
    invoke-static {p1, p2, p3, p4}, Lcom/google/common/collect/k6;->L(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/k6;
    ...
    .line 6
    iput-object p4, p0, Lcom/google/common/util/concurrent/i0$s;->g:Lcom/google/common/util/concurrent/i0;

    return-void
.end method

.method synthetic constructor <init>(Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0$b;)V
    .locals 0

    .prologue
    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/common/util/concurrent/i0$s;-><init>(Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;Lcom/google/common/util/concurrent/i0;)V

    return-void
.end method

.method static synthetic h(Lcom/google/common/util/concurrent/i0$s;)Lcom/google/common/util/concurrent/i0;
    .locals 0
...
.method static synthetic i(Lcom/google/common/util/concurrent/i0$s;)Lcom/google/common/util/concurrent/i0;
    .locals 0
...
.method static synthetic j(Lcom/google/common/util/concurrent/i0$s;)Lcom/google/common/util/concurrent/i0;
    .locals 0
...
.method static synthetic k(Lcom/google/common/util/concurrent/i0$s;)Lcom/google/common/util/concurrent/i0;
    .locals 0

    .prologue
    .line 1
    iget-object p0, p0, Lcom/google/common/util/concurrent/i0$s;->g:Lcom/google/common/util/concurrent/i0;
...
# virtual methods
.method public l(Lcom/google/common/util/concurrent/i0$s$d;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/i0;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x10,
...
.method public m(Lcom/google/common/util/concurrent/i0$s$c;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/i0;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x10,
