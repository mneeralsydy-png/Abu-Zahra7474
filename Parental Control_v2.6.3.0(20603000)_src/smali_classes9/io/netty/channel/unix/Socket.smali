...
.method public static initialize()V
    ...
    .prologue
    .line 1
    invoke-static {}, Lio/netty/util/w;->isIpV4StackPreferred()Z
...
.method protected static newSocketDgram0(Lio/netty/channel/socket/l;)I
    .locals 0

    .prologue
    .line 2
    invoke-static {p0}, Lio/netty/channel/unix/Socket;->shouldUseIpv6(Lio/netty/channel/socket/l;)Z
...
.method protected static newSocketStream0(Lio/netty/channel/socket/l;)I
    .locals 0
...
.method private static native recvFrom(ILjava/nio/ByteBuffer;II)Lio/netty/channel/unix/a;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private static native recvFromAddress(IJII)Lio/netty/channel/unix/a;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private static native recvFromAddressDomainSocket(IJII)Lio/netty/channel/unix/e;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private static native recvFromDomainSocket(ILjava/nio/ByteBuffer;II)Lio/netty/channel/unix/e;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public static shouldUseIpv6(Lio/netty/channel/socket/l;)Z
    .locals 1
    ...
    .line 8
    :cond_0
    sget-object v0, Lio/netty/channel/socket/l;->IPv6:Lio/netty/channel/socket/l;
...
.method public final bind(Ljava/net/SocketAddress;)V
    ...
    .line 4
    invoke-static {v0}, Lio/netty/channel/unix/n;->newInstance(Ljava/net/InetAddress;)Lio/netty/channel/unix/n;
    ...
    iget-object v4, v2, Lio/netty/channel/unix/n;->address:[B

    iget v2, v2, Lio/netty/channel/unix/n;->scopeId:I
    ...
    invoke-virtual {p1}, Lio/netty/channel/unix/f;->path()Ljava/lang/String;
...
.method public final connect(Ljava/net/SocketAddress;)Z
    ...
    iget-object v3, v1, Lio/netty/channel/unix/n;->address:[B

    iget v1, v1, Lio/netty/channel/unix/n;->scopeId:I
...
.method public final localAddress()Ljava/net/InetSocketAddress;
    ...
    invoke-static {v0, v1, v2}, Lio/netty/channel/unix/n;->address([BII)Ljava/net/InetSocketAddress;
...
.method public final localDomainSocketAddress()Lio/netty/channel/unix/f;
    .locals 3
    ...
    .line 2
    :cond_0
    new-instance v1, Lio/netty/channel/unix/f;

    new-instance v2, Ljava/lang/String;

    invoke-direct {v2, v0}, Ljava/lang/String;-><init>([B)V

    invoke-direct {v1, v2}, Lio/netty/channel/unix/f;-><init>(Ljava/lang/String;)V
...
.method public final recvFrom(Ljava/nio/ByteBuffer;II)Lio/netty/channel/unix/a;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v0, p1, p2, p3}, Lio/netty/channel/unix/Socket;->recvFrom(ILjava/nio/ByteBuffer;II)Lio/netty/channel/unix/a;
...
.method public final recvFromAddress(JII)Lio/netty/channel/unix/a;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v0, p1, p2, p3, p4}, Lio/netty/channel/unix/Socket;->recvFromAddress(IJII)Lio/netty/channel/unix/a;
...
.method public final recvFromAddressDomainSocket(JII)Lio/netty/channel/unix/e;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v0, p1, p2, p3, p4}, Lio/netty/channel/unix/Socket;->recvFromAddressDomainSocket(IJII)Lio/netty/channel/unix/e;
...
.method public final recvFromDomainSocket(Ljava/nio/ByteBuffer;II)Lio/netty/channel/unix/e;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v0, p1, p2, p3}, Lio/netty/channel/unix/Socket;->recvFromDomainSocket(ILjava/nio/ByteBuffer;II)Lio/netty/channel/unix/e;
...
.method public final remoteDomainSocketAddress()Lio/netty/channel/unix/f;
    .locals 3
...
.method public final sendTo(Ljava/nio/ByteBuffer;IILjava/net/InetAddress;IZ)I
    ...
    invoke-static {v2}, Lio/netty/channel/unix/n;->ipv4MappedIpv6Address([B)[B
