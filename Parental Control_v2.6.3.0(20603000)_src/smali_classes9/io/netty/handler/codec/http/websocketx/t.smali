.class public Lio/netty/handler/codec/http/websocketx/t;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/netty/handler/codec/http/websocketx/t;->MAGIC_GUID:Ljava/lang/String;

    .line 1
    const-class v0, Lio/netty/handler/codec/http/websocketx/t;
    ...
    .line 7
    sput-object v0, Lio/netty/handler/codec/http/websocketx/t;->logger:Lio/netty/util/internal/logging/f;
...
.method public constructor <init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;I)V
    ...
    .line 1
    invoke-direct/range {v0 .. v8}, Lio/netty/handler/codec/http/websocketx/t;-><init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZ)V
...
.method public constructor <init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZ)V
    ...
    .line 2
    invoke-direct/range {v0 .. v10}, Lio/netty/handler/codec/http/websocketx/t;-><init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZJ)V
...
.method public constructor <init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZJ)V
    ...
    .line 3
    invoke-direct/range {v0 .. v11}, Lio/netty/handler/codec/http/websocketx/t;-><init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZJZ)V
...
.method constructor <init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZJZ)V
    ...
    .line 4
    invoke-direct/range {v0 .. v12}, Lio/netty/handler/codec/http/websocketx/t;-><init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZJZZ)V
...
.method constructor <init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/s0;Ljava/lang/String;ZLio/netty/handler/codec/http/j0;IZZJZZ)V
    ...
    .line 6
    iput-boolean v0, v10, Lio/netty/handler/codec/http/websocketx/t;->allowExtensions:Z

    move/from16 v0, p7

    .line 7
    iput-boolean v0, v10, Lio/netty/handler/codec/http/websocketx/t;->performMasking:Z

    move/from16 v0, p8

    .line 8
    iput-boolean v0, v10, Lio/netty/handler/codec/http/websocketx/t;->allowMaskMismatch:Z
...
.method protected newHandshakeRequest()Lio/netty/handler/codec/http/t;
    ...
    .line 35
    iput-object v2, p0, Lio/netty/handler/codec/http/websocketx/t;->expectedChallengeResponseString:Ljava/lang/String;

    .line 37
    sget-object v2, Lio/netty/handler/codec/http/websocketx/t;->logger:Lio/netty/util/internal/logging/f;
    ...
    .line 47
    iget-object v4, p0, Lio/netty/handler/codec/http/websocketx/t;->expectedChallengeResponseString:Ljava/lang/String;
...
.method protected newWebSocketEncoder()Lio/netty/handler/codec/http/websocketx/f0;
    ...
    .prologue
    .line 1
    new-instance v0, Lio/netty/handler/codec/http/websocketx/l;

    .line 3
    iget-boolean v1, p0, Lio/netty/handler/codec/http/websocketx/t;->performMasking:Z

    .line 5
    invoke-direct {v0, v1}, Lio/netty/handler/codec/http/websocketx/l;-><init>(Z)V
...
.method protected newWebsocketDecoder()Lio/netty/handler/codec/http/websocketx/e0;
    ...
    .prologue
    .line 1
    new-instance v0, Lio/netty/handler/codec/http/websocketx/k;

    .line 3
    iget-boolean v1, p0, Lio/netty/handler/codec/http/websocketx/t;->allowExtensions:Z
    ...
    .line 9
    iget-boolean v3, p0, Lio/netty/handler/codec/http/websocketx/t;->allowMaskMismatch:Z

    .line 11
    const/4 v4, 0x0

    .line 12
    invoke-direct {v0, v4, v1, v2, v3}, Lio/netty/handler/codec/http/websocketx/k;-><init>(ZZIZ)V
...
.method public bridge synthetic setForceCloseTimeoutMillis(J)Lio/netty/handler/codec/http/websocketx/r;
    ...
    .prologue
    .line 1
    invoke-virtual {p0, p1, p2}, Lio/netty/handler/codec/http/websocketx/t;->setForceCloseTimeoutMillis(J)Lio/netty/handler/codec/http/websocketx/t;
...
.method public setForceCloseTimeoutMillis(J)Lio/netty/handler/codec/http/websocketx/t;
    .locals 0
...
.method protected verify(Lio/netty/handler/codec/http/u;)V
    ...
    .line 50
    iget-object v1, p0, Lio/netty/handler/codec/http/websocketx/t;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    .line 61
    iget-object v2, p0, Lio/netty/handler/codec/http/websocketx/t;->expectedChallengeResponseString:Ljava/lang/String;
