.class public Lio/netty/handler/codec/marshalling/c;
...
.field protected final provider:Lio/netty/handler/codec/marshalling/n;
...
.method public constructor <init>(Lio/netty/handler/codec/marshalling/n;I)V
    ...
    .line 4
    iput-object p1, p0, Lio/netty/handler/codec/marshalling/c;->provider:Lio/netty/handler/codec/marshalling/n;

    .line 6
    iput p2, p0, Lio/netty/handler/codec/marshalling/c;->maxObjectSize:I
...
.method protected decode(Lio/netty/channel/r;Lio/netty/buffer/j;Ljava/util/List;)V
    ...
    .prologue
    .line 1
    iget-boolean v0, p0, Lio/netty/handler/codec/marshalling/c;->discardingTooLongFrame:Z
    ...
    .line 16
    :cond_0
    iget-object v0, p0, Lio/netty/handler/codec/marshalling/c;->provider:Lio/netty/handler/codec/marshalling/n;
    ...
    .line 27
    iget p2, p0, Lio/netty/handler/codec/marshalling/c;->maxObjectSize:I
    ...
    .line 34
    new-instance p2, Lio/netty/handler/codec/marshalling/h;

    .line 36
    iget v1, p0, Lio/netty/handler/codec/marshalling/c;->maxObjectSize:I

    .line 38
    int-to-long v1, v1

    .line 39
    invoke-direct {p2, v0, v1, v2}, Lio/netty/handler/codec/marshalling/h;-><init>(Lorg/jboss/marshalling/ByteInput;J)V
    ...
    :try_end_0
    .catch Lio/netty/handler/codec/marshalling/h$a; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 63
    :try_start_1
    iput-boolean p2, p0, Lio/netty/handler/codec/marshalling/c;->discardingTooLongFrame:Z
...
.method protected decodeLast(Lio/netty/channel/r;Lio/netty/buffer/j;Ljava/util/List;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Lio/netty/handler/codec/marshalling/c;->decode(Lio/netty/channel/r;Lio/netty/buffer/j;Ljava/util/List;)V
