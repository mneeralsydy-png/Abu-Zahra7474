...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .prologue
    .line 1
    sget-object v6, Lio/netty/handler/ssl/x;->INSTANCE:Lio/netty/handler/ssl/x;

    sget-object v7, Lio/netty/handler/ssl/f0;->INSTANCE:Lio/netty/handler/ssl/f0;
    ...
    invoke-direct/range {v0 .. v12}, Lio/netty/handler/ssl/k0;-><init>(Ljava/security/Provider;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/d0;JJLjava/lang/String;)V
...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
    ...
    sget-object v6, Lio/netty/handler/ssl/f0;->INSTANCE:Lio/netty/handler/ssl/f0;
    ...
    invoke-direct/range {v0 .. v10}, Lio/netty/handler/ssl/k0;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/d0;JJ)V
...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;JJ)V
    ...
    .line 8
    invoke-direct/range {v1 .. v13}, Lio/netty/handler/ssl/k0;-><init>(Ljava/security/Provider;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/d0;JJLjava/lang/String;)V

    return-void
.end method

.method public constructor <init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/d0;JJ)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public constructor <init>(Ljava/io/File;Ljavax/net/ssl/TrustManagerFactory;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;JJ)V
    ...
    .line 15
    invoke-static/range {v0 .. v11}, Lio/netty/handler/ssl/k0;->newSSLContext(Ljava/security/Provider;[Ljava/security/cert/X509Certificate;Ljavax/net/ssl/TrustManagerFactory;[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;JJLjava/lang/String;)Ljavax/net/ssl/SSLContext;
    ...
    invoke-direct/range {v12 .. v20}, Lio/netty/handler/ssl/i0;-><init>(Ljavax/net/ssl/SSLContext;ZLjava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;Lio/netty/handler/ssl/p;[Ljava/lang/String;Z)V
...
.method constructor <init>(Ljava/security/Provider;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/d0;JJLjava/lang/String;)V
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {p3 .. p4}, Lio/netty/handler/ssl/i2;->toPrivateKeyInternal(Ljava/io/File;Ljava/lang/String;)Ljava/security/PrivateKey;
    ...
    sget-object v13, Lio/netty/handler/ssl/p;->NONE:Lio/netty/handler/ssl/p;
    ...
    invoke-direct/range {v7 .. v15}, Lio/netty/handler/ssl/i0;-><init>(Ljavax/net/ssl/SSLContext;ZLjava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/d0;Lio/netty/handler/ssl/p;[Ljava/lang/String;Z)V
...
.method private static newSSLContext(Ljava/security/Provider;[Ljava/security/cert/X509Certificate;Ljavax/net/ssl/TrustManagerFactory;[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;JJLjava/lang/String;)Ljavax/net/ssl/SSLContext;
    ...
    .line 26
    :try_start_0
    invoke-static {p1, p2, v3}, Lio/netty/handler/ssl/i2;->buildTrustManagerFactory([Ljava/security/cert/X509Certificate;Ljavax/net/ssl/TrustManagerFactory;Ljava/lang/String;)Ljavax/net/ssl/TrustManagerFactory;
    ...
    .line 61
    invoke-static/range {v1 .. v6}, Lio/netty/handler/ssl/i2;->buildKeyManagerFactory([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/security/PrivateKey;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/String;)Ljavax/net/ssl/KeyManagerFactory;
    ...
    .line 89
    invoke-static {v2}, Lio/netty/handler/ssl/k0;->wrapTrustManagerIfNeeded([Ljavax/net/ssl/TrustManager;)[Ljavax/net/ssl/TrustManager;
...
.method private static wrapTrustManagerIfNeeded([Ljavax/net/ssl/TrustManager;)[Ljavax/net/ssl/TrustManager;
    ...
    .line 18
    new-instance v2, Lio/netty/handler/ssl/u;

    .line 20
    check-cast v1, Ljavax/net/ssl/X509ExtendedTrustManager;

    .line 22
    invoke-direct {v2, v1}, Lio/netty/handler/ssl/u;-><init>(Ljavax/net/ssl/X509TrustManager;)V
