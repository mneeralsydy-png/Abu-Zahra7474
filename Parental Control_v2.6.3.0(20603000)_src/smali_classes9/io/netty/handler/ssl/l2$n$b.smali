.class final enum Lio/netty/handler/ssl/l2$n$b;
...
.method allocateWrapBuffer(Lio/netty/handler/ssl/l2;Lio/netty/buffer/k;II)Lio/netty/buffer/j;
    ...
    .line 5
    check-cast p1, Lio/netty/handler/ssl/r;

    .line 7
    invoke-virtual {p1, p3, p4}, Lio/netty/handler/ssl/r;->calculateOutNetBufSize(II)I
...
.method calculateRequiredOutBufSpace(Lio/netty/handler/ssl/l2;II)I
    ...
    .line 7
    invoke-virtual {p1, p2, p3}, Lio/netty/handler/ssl/r;->calculateRequiredOutBufSpace(II)I
...
.method unwrap(Lio/netty/handler/ssl/l2;Lio/netty/buffer/j;ILio/netty/buffer/j;)Ljavax/net/ssl/SSLEngineResult;
    ...
    .line 22
    invoke-static {p4, v1, v4}, Lio/netty/handler/ssl/l2;->access$300(Lio/netty/buffer/j;II)Ljava/nio/ByteBuffer;
    ...
    .line 32
    check-cast v3, Lio/netty/handler/ssl/r;
    ...
    .line 46
    invoke-virtual {v3, p2, p3}, Lio/netty/handler/ssl/r;->unwrap([Ljava/nio/ByteBuffer;[Ljava/nio/ByteBuffer;)Ljavax/net/ssl/SSLEngineResult;
