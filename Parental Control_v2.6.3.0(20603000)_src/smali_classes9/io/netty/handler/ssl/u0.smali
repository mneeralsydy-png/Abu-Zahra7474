.class public final Lio/netty/handler/ssl/u0;
...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v13}, Lio/netty/handler/ssl/u0;-><init>(Ljava/io/File;Ljavax/net/ssl/TrustManagerFactory;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;JJ)V
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    .line 2
    invoke-direct {p0, p1, v0}, Lio/netty/handler/ssl/u0;-><init>(Ljava/io/File;Ljavax/net/ssl/TrustManagerFactory;)V
...
.method public constructor <init>(Ljava/io/File;Ljavax/net/ssl/TrustManagerFactory;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;JJ)V
    ...
    .line 10
    invoke-direct/range {v0 .. v17}, Lio/netty/handler/ssl/u0;-><init>([Ljava/security/cert/X509Certificate;Ljavax/net/ssl/TrustManagerFactory;[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;[Ljava/lang/String;JJZLjava/lang/String;[Ljava/util/Map$Entry;)V

    return-void
.end method

.method public constructor <init>(Ljava/io/File;Ljavax/net/ssl/TrustManagerFactory;Ljava/lang/Iterable;Lio/netty/handler/ssl/c;JJ)V
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public constructor <init>(Ljavax/net/ssl/TrustManagerFactory;)V
    ...
    .line 3
    invoke-direct {p0, v0, p1}, Lio/netty/handler/ssl/u0;-><init>(Ljava/io/File;Ljavax/net/ssl/TrustManagerFactory;)V
...
.method varargs constructor <init>([Ljava/security/cert/X509Certificate;Ljavax/net/ssl/TrustManagerFactory;[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;[Ljava/lang/String;JJZLjava/lang/String;[Ljava/util/Map$Entry;)V
    ...
    invoke-direct/range {v1 .. v11}, Lio/netty/handler/ssl/w0;-><init>(Ljava/lang/Iterable;Lio/netty/handler/ssl/n;Lio/netty/handler/ssl/c;I[Ljava/security/cert/Certificate;Lio/netty/handler/ssl/p;[Ljava/lang/String;ZZ[Ljava/util/Map$Entry;)V
    ...
    :try_start_2
    iput-object v0, v1, Lio/netty/handler/ssl/u0;->sessionContext:Lio/netty/handler/ssl/l1;
    :try_end_2
...
.method public sessionContext()Lio/netty/handler/ssl/l1;
    ...
    .prologue
    .line 2
    iget-object v0, p0, Lio/netty/handler/ssl/u0;->sessionContext:Lio/netty/handler/ssl/l1;
...
.method public bridge synthetic sessionContext()Ljavax/net/ssl/SSLSessionContext;
    ...
    .prologue
    .line 1
    invoke-virtual {p0}, Lio/netty/handler/ssl/u0;->sessionContext()Lio/netty/handler/ssl/l1;
