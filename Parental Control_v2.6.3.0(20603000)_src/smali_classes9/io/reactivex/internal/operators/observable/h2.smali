...
.method public constructor <init>(Lio/reactivex/g0;)V
    ...
    .line 4
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/h2;->b:Lio/reactivex/g0;
    ...
    .line 11
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/h2;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method protected I5(Lio/reactivex/i0;)V
    ...
    .line 1
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/h2;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 13
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/h2;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 30
    invoke-direct {v1, p1, v0}, Lio/reactivex/internal/operators/observable/h2$a;-><init>(Lio/reactivex/i0;Lio/reactivex/internal/operators/observable/h2$b;)V

    .line 33
    invoke-interface {p1, v1}, Lio/reactivex/i0;->f(Lio/reactivex/disposables/c;)V

    .line 36
    invoke-virtual {v0, v1}, Lio/reactivex/internal/operators/observable/h2$b;->a(Lio/reactivex/internal/operators/observable/h2$a;)Z
    ...
    .line 42
    invoke-virtual {v1}, Lio/reactivex/internal/operators/observable/h2$a;->d()Z
    ...
    .line 48
    invoke-virtual {v0, v1}, Lio/reactivex/internal/operators/observable/h2$b;->b(Lio/reactivex/internal/operators/observable/h2$a;)V
    ...
    .line 52
    :cond_3
    iget-object v0, v0, Lio/reactivex/internal/operators/observable/h2$b;->f:Ljava/lang/Throwable;
...
.method public m8(Lgh/g;)V
    ...
    .line 11
    invoke-virtual {v0}, Lio/reactivex/internal/operators/observable/h2$b;->d()Z
    ...
    .line 34
    :cond_2
    iget-object v1, v0, Lio/reactivex/internal/operators/observable/h2$b;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 58
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/h2;->b:Lio/reactivex/g0;
...
.method public source()Lio/reactivex/g0;
    ...
    .prologue
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/h2;->b:Lio/reactivex/g0;
